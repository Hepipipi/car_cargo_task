"""
Django settings for nearest_cars project.
...
SECRET_KEY = 'django-insecure-t4t%bk9&5^v^_ulm+eusks4cw-89ty71-#84oeab_@3mt&hc1x'
...
ROOT_URLCONF = 'nearest_cars.urls'
...
WSGI_APPLICATION = 'nearest_cars.wsgi.application'
